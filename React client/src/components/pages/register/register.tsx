            ...
            <div className="register__container">
                ...
                <form className="register-form33">
                    ...
                    <div className="gender">
                        ...
                        <input type="radio" value="OTHER" id="other_status" name="gender" onChange={e => setGender(e.target.value)} />
                    ...
                    <div className="gender">
                        ...
                        <input type="radio" value="OTHER" id="other_gender" name="marital_status" onChange={e => setGender(e.target.value)} />
                        <label className="gender__label">Other</label>
                    </div>
