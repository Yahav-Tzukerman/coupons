                ...
                <Col sm={12}>
                    <div className="about-us-container">
                        <Row>
                            ...
                            <div className="home-coupons-display">
                                <Col sm={12}>
                                    <h1 className="some-coupons"> Yu Gi Ho!</h1>
                                    <div className="cards-container">
                                        <CardsContainer
                                            coupons={coupons}
                                        />
                            ...
                            <div className="about-us-dark-footer">
                                ...
                                <Col sm={4}>
                                    <input type="button" value="Yu Gi Ho" className="go-to-link-button" onClick={() => navigate('/company/19')} />
                                </Col>
                            </div>
                            <div className="about-us">
                                <div className='to-all'>
                                    <Col sm={6}>
                                        ...
                                        <input type="button" value="Enter" className="go-to-link-button-2" onClick={() => navigate('/coupons')} />
                                    </Col>
                                    <Col sm={6}>
                                        <h1 className="about-us-heading">
                                            To brands page
                                        ...
                                        <input type="button" value="Enter" className="go-to-link-button-2" onClick={() => navigate('/companies')} />
                                    </Col>
                                </div>
                            </div>
                            <div className="about-us-dark-footer">
                                ...
                                <Col sm={3}>
                                    <input type="button" value="contact" className="go-to-link-button" onClick={() => { }} />
                                </Col>
                            </div>
                        </Row>
                    </div>
