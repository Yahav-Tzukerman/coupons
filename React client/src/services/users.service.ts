...
const loginWithGoogle = () => {
  return axios.post(BASE_URL + `/login/oauth2/code/google`);
};
...
const UserService = { login, register, getAllUsers, addUser, updateUser, deleteUser, getUserById, loginWithGoogle };
